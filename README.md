...
<br>
<p style="font-weight: bold;font-size: 2rem;">🌐 Socials:</p>
...
<br>
<p style="font-weight: bold;font-size: 2rem;">💻 Tech Stack:</p>
<div style="display: flex; justify-content: center;flex-wrap: wrap; gap: rem;">
